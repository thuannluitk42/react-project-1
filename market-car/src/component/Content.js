  ...
  return (
    ...
    <Box>
      <Box sx={{ display: 'flex', justify: 'flex-start', alignItems: 'center' }}>
        <Typography variant="h5" sx={{ paddingRight: 10, backgroundColor: '#ddd', mr: 10, color: '#2F465F' }}>CAR BRANDS LIST</Typography>
        <FormControl sx={{ minWidth: 120, paddingRight: 10, backgroundColor: '#ddd', mr: 10 }}>
        ...
        <TextField id="outlined-search" label="Search car brand" type="search" />
